...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 tests/eval/rubrics/comp.slots-over-config.md carries an explicit NOT-a-violation criterion for data-driven slot selection, referencing the pass example's events.length pattern
- [ ] #2 tests/eval/rubrics/README.md records the dated reset rationale; rubric text contains no occurrence of the substring skill (judge-prompt blindness test)
- [ ] #3 Repo gates green
<!-- AC:END -->
