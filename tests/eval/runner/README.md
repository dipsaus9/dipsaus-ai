...
`--concurrency` (parallel model sessions, default 4 — pass 1 for strictly serial runs;
higher values risk API rate limits and local tsc/vitest load; progress lines interleave),
